...
<tbody>
<tr><th>이름</th>
     <td><input name='name' value=<%=member.getName() %> readonly></td></tr>
<tr><th>아이디</th>
     <td><input name='id' value=<%=member.getId() %> readonly></td></tr>
<tr><th>이메일</th>
     <td><input name='email' value=<%=member.getEmail() %> readonly></td></tr>
<tr><th>닉네임</th>
     <td><input name='nick' type='text' value=<%=member.getNick() %>></td></tr>
<tr><th>비밀번호</th>
     <td><input name='password' type='password'></td></tr>
<tr><th>비밀번호 확인</th>
     <td><input name='checkPassword' type='password'></td></tr>
<tr><th>휴대전화</th>
     <td><input name='tel' type='tel' value=<%=member.getTel() %>></td></tr><br>
</tbody>
</table>
